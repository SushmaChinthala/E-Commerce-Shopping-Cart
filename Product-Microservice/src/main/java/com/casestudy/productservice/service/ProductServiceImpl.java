...
public class ProductServiceImpl implements ProductService {
	...
	public Product saveProductDetails(Product products, MultipartFile[] file) throws ProductNotFoundException, Exception {
		logger.info("Sucessfully Registered new Product");
	...
	public Product addProduct(Product product) throws ProductAlreadyExistsException {
		if (productRepository.existsById(product.getProductId())) {
             ProductAlreadyExistsException p=new ProductAlreadyExistsException("Product is already existing ");
			p.getMessage();
             throw  p;
		}
